...
| 🎯 Open queue | T24 (deletion vectors — decide first), T28 (real-writer fixtures), T29 (DuckDB output verification), T30 (Java interop nightly — after T28/T29) |

**Picking up the queue.** The tasks are independent; take them in any order. T24 is a decision
