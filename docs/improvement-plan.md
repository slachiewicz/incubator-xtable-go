...
| | Tasks |
|---|---|
| ✅ Done | T1, T3 (via T12), T4, T5, T6, T9, T11, T12, T16, T18, T22 |
...
| 🎯 Open queue | T20 (column stats), T21 (Delta backlog reads), T23 (catalog discovery), T24 (deletion vectors — decide first), T25 (pre-port fix audit), T26 (Delta incremental timestamp basis — investigate first) |
